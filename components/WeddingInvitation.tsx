  ...
  >
    ...
    >
      <svg width="300" height="300" viewBox="0 0 300 300" className="opacity-80">
        ...
        <circle cx="100" cy="100" r="40" fill="url(#flowerGold1)" opacity="0.3" />
        <circle cx="70" cy="80" r="25" fill="url(#flowerGold1)" opacity="0.4" />
        <circle cx="130" cy="80" r="25" fill="url(#flowerGold1)" opacity="0.4" />
        <circle cx="80" cy="130" r="25" fill="url(#flowerGold1)" opacity="0.4" />
        <circle cx="120" cy="130" r="25" fill="url(#flowerGold1)" opacity="0.4" />
        <circle cx="100" cy="100" r="20" fill="#F0D78C" opacity="0.6" />
        {/* Smaller flowers */}
        <circle cx="180" cy="50" r="15" fill="url(#flowerGold1)" opacity="0.3" />
        <circle cx="165" cy="45" r="8" fill="#D4A84B" opacity="0.4" />
        <circle cx="195" cy="45" r="8" fill="#D4A84B" opacity="0.4" />
        <circle cx="180" cy="30" r="8" fill="#D4A84B" opacity="0.4" />
        <circle cx="180" cy="60" r="8" fill="#D4A84B" opacity="0.4" />
      </svg>
    </motion.div>
    ...
    >
      <svg width="300" height="300" viewBox="0 0 300 300" className="opacity-80">
        ...
        <circle cx="200" cy="200" r="40" fill="url(#flowerGold2)" opacity="0.3" />
        <circle cx="170" cy="180" r="25" fill="url(#flowerGold2)" opacity="0.4" />
        <circle cx="230" cy="180" r="25" fill="url(#flowerGold2)" opacity="0.4" />
        <circle cx="180" cy="230" r="25" fill="url(#flowerGold2)" opacity="0.4" />
        <circle cx="220" cy="230" r="25" fill="url(#flowerGold2)" opacity="0.4" />
        <circle cx="200" cy="200" r="20" fill="#F0D78C" opacity="0.6" />
        {/* Smaller flowers */}
        <circle cx="120" cy="250" r="15" fill="url(#flowerGold2)" opacity="0.3" />
        <circle cx="105" cy="245" r="8" fill="#D4A84B" opacity="0.4" />
        <circle cx="135" cy="245" r="8" fill="#D4A84B" opacity="0.4" />
        <circle cx="120" cy="230" r="8" fill="#D4A84B" opacity="0.4" />
        <circle cx="120" cy="260" r="8" fill="#D4A84B" opacity="0.4" />
      </svg>
    </motion.div>
      ...
      {[...Array(8)].map((_, i) => (
        ...
        >
          <svg width="20" height="20" viewBox="0 0 20 20">
            <ellipse cx="10" cy="10" rx="8" ry="4" fill="#F0D78C" opacity="0.6" transform={`rotate(${i * 45} 10 10)`} />
          </svg>
        </motion.div>
      ))}
    </motion.div>
